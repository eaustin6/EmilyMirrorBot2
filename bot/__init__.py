...
try:
    ...
    LOG_UNAME = getConfig('LOG_CHANNEL_ID')
    LOG_CHANNEL = getConfig('LOG_CHANNEL_ID')
...
try:
    ...
    IMAGE_URL = 'https://telegra.ph/file/b6bb74e0565727c12e4f7.jpg'
try:
    CHANNEL_LINK = getConfig('CHANNEL_LINK')
    if len(CHANNEL_LINK) == 0:
        CHANNEL_LINK = None
except KeyError:
    CHANNEL_LINK = 'https://t.me/emilymirror'
try:
    SUPPORT_LINK = getConfig('SUPPORT_LINK')
    if len(SUPPORT_LINK) == 0:
        SUPPORT_LINK = None
except KeyError:
    SUPPORT_LINK = 'https://t.me/missemily2022'    
