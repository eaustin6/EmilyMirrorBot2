...
## Features added by [Miss Emily](https://github.com/missemily2022)
- Added Sending Link to User Private DM as well as send the Downloaded Fle Message to a separate Log Channel
- Added Usage Command to check status of Heroku Account ( For Heroku Deployed Mirror Bots)
- Added Sending Restart Notification of Bots to two different groups
